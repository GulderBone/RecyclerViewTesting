...
class CustomLayoutManager2(
    ...
    override fun onLayoutChildren(recycler: RecyclerView.Recycler, state: RecyclerView.State) {
        ...
        if (childCount == 0 || ((!state.isPreLayout && getVisibleChildCount() >= state.itemCount))) {
            ...
            if (!state.isPreLayout && width > (rows * _decoratedChildHeight)) {
    ...
    override fun scrollHorizontallyBy(dx: Int, recycler: RecyclerView.Recycler, state: RecyclerView.State): Int {
        ...
        val rightBoundReached = lastVisibleColumn >= columns
        val delta: Int =
    ...
    private val firstVisibleColumn: Int get() = _firstVisiblePosition % columns
    private val lastVisibleColumn: Int get() = firstVisibleColumn + columns
    private val firstVisibleRow: Int get() = _firstVisiblePosition / columns
